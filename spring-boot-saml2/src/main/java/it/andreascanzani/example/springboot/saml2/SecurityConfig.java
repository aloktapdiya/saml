	...
	protected RelyingPartyRegistrationRepository relyingPartyRegistrations() throws Exception {
	    ...
	    RelyingPartyRegistration registration = RelyingPartyRegistration
	            ...
	            .assertingPartyDetails(party -> party
	                ...
	                .veripackage it.andreascanzani.example.springboot.saml2;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected RelyingPartyRegistrationRepository relyingPartyRegistrations() throws Exception {
	    ...
	    RelyingPartyRegistration registration = RelyingPartyRegistration
	            .withRegistrationId("okta-saml")
	            .assertingPartyDetails(party -> party
	                .entityId("http://www.okta.com/exk5l69tqfx3ZcFzB5d7")
	                .singleSignOnServiceLocation("https://dev-10781564.okta.com/app/dev-10781564_appsaml_1/exk5l69tqfx3ZcFzB5d7/sso/saml")
	                .wantAuthnRequestsSigned(false)
...
ficationX509Credentials(c -> c.add(credential))
	            ).build();
	    return new InMemoryRelyingPartyRegistrationRepository(registration);
	}
